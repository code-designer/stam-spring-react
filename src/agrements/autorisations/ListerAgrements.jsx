    ...
    return (
        <>
            <div className="mx-auto">
                <h3 className="text-center">AGREMENTS</h3>
                <div className="d-flex justify-content-between my-3">
                    <div className="me-3">
                        <Link to="/actes/agrements/nouveau" className='btn'><i className='bi bi-plus'></i></Link>
...
export default ListerAgrements;