...
function AjouterAgrement({ agrement }) {
    const form = useForm({
        defaultValues: {
    ...
    return (
        <>
            <div className="w-sm-100  w-75 mx-auto my-3 shadow">
                <h3 className="text-center rounded-top p-3 bg-info">Ajouter un agrement de sous-traitance</h3>
                <form action="" method="post" className="form p-4" onSubmit={(e) => handleSubmit(e)}>
                    ...
                    </h3>
                    {
                        ...
                        <div className="mb-3 ms-3">
                            ...
                            <div className="mb-3">
                                <label className="form-label" htmlFor="referenceNumberAct">Numero de reference</label>
                                <input type="text" className="form-control" name="referenceNumberAct" id="referenceNumberAct"
                                    placeholder="Numero de reference" {...register("referenceNumberAct")} />
                            </div>
                            <div className="mb-3">
                                <label className="form-label" htmlFor="domain">Domaine</label>
                                <input type="text" className="form-control" name="domain" id="domain"
                                    placeholder="domaine" {...register("domain")} />
                            </div>
                            <div className="mb-3">
                                <label className="form-label" htmlFor="state">Etat</label>
                                <input type="text" className="form-control" name="state" id="state"
                                    placeholder="Etat" {...register("state")} />
                            </div>
                            <div className="mb-3">
                                <label className="form-label" htmlFor="observations">Observations</label>
                                <textarea name="observations" className="form-control" id="observations"
...
export default AjouterAgrement;