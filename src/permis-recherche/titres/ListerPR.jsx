    ...
    return (
        <>
            <div className="mx-auto">
                <h3 className="text-center">PERMIS DE RECHERCHE</h3>
                <div className="d-flex justify-content-between my-3">
                    <div className="me-3">
                        <Link to="/actes/permis-recherche/nouveau" className='btn'><i className='bi bi-plus'></i></Link>
