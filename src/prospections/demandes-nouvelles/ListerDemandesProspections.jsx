...
function ListerDemandesProspections() {
    ...
    return (
        <>
            <div className="mx-auto">
                <h3 className="text-center">DEMANDES DE PROSPECTIONS</h3>
                <div className="d-flex justify-content-between my-3">
                    <div className="me-3">
                        <Link to="/prospections/nouveau" className='btn'><i className='bi bi-plus'></i></Link>
...
export default ListerDemandesProspections;